---
description: Запуск цикла разработки по AI-контракту
---
...
3. **Реализуй** код (HTML5, Tailwind CSS, Alpine.js).
4. **Проверка:**
   - Открой в браузере и проверь мобильный вид (375px).
   - Проверь все ссылки, кнопки, формы.
5. **Только если всё работает** - готово к сдаче.
6. **Самоконтроль**: перепроверь критические запреты (особенно комментарии, inline-стили).
